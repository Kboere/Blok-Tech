function Survey(survey) {
  ...
  const question1Radios = survey.querySelectorAll("[name='vraag1']");
  const question2Radios = survey.querySelectorAll("[name='vraag2']");
  const question3CheckBoxes = survey.querySelectorAll("[name='vraag3']");
  const question4Radios = survey.querySelectorAll("[name='vraag4']");
  const question4Textarea = survey.querySelector("[name='recommend']");
